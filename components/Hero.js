...
const Hero = () => {
  return (
    <>
<div className="bg-gradient-to-b from-orange-100 to-green-200">
 <section className="py-10 sm:py-16 lg:py-24">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    <h1 className="text-4xl font-bold text-black sm:text-6xl lg:text-7xl">
                        Sainik School, Entrance Exam PREP
                    ...
                    <p className="mt-8 text-base text-black sm:text-xl">FPA offers a meticulously crafted curriculum designed specifically to cover all the essential topics and concepts required for the Sainik School Entrance Exam. Our comprehensive study materials ensure thorough preparation to excel in the exam.</p>
                ...
                <div>
                    <Image className="w-full" src="/si1.png" alt="" width={1080} height={1080}/>
                </div>
            </div>
        </div>
    </section>
