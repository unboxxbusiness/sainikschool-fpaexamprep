        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    ...
                    <p className="mt-8 text-base text-black sm:text-xl">Supercharge Your CUET 2024 Entrance Exam Preparation with FPA: Your Comprehensive and Strategic Study Partner</p>
                    ...
                    <div className="mt-10 sm:flex sm:items-center sm:space-x-8">
                        ...
                        <Link href="https://www.youtube.com/watch?v=J1uptscnmA0" title="" className="inline-flex items-center mt-6 text-base font-semibold transition-all duration-200 sm:mt-0 hover:opacity-80">
                ...
                <div>
                    <Image className="w-full" src="/back1.png" alt="" width={1080} height={1080}/>
                </div>
            </div>
        </div>
    </section>
