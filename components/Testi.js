  ...
  return (
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold leading-tight text-gray-800 sm:text-4xl lg:text-5xl"><span className="text-blue-600"></span> Exam Success Made Easy: Hear What Our Students Say</h2>
        </div>
            ...
            <div className="overflow-hidden bg-white rounded-md shadow">
                <div className="px-8 py-12">
                    <div className="relative w-24 h-24 mx-auto">
                        <Image className="relative object-cover w-24 h-24 mx-auto rounded-full" src="/b12.png" alt="" width={100} height={100} />
